...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.listEntryByAccountIdStmt, err = db.PrepareContext(ctx, listEntryByAccountId); err != nil {
		return nil, fmt.Errorf("error preparing query ListEntryByAccountId: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.listEntryByAccountIdStmt != nil {
		if cerr := q.listEntryByAccountIdStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listEntryByAccountIdStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	listEntryByAccountIdStmt *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		listEntryByAccountIdStmt: q.listEntryByAccountIdStmt,
