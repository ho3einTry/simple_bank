...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 simpleBankDB.AddAccountBalanceParams) (simpleBankDB.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 simpleBankDB.CreateUserParams) (simpleBankDB.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", arg0, arg1)
	ret0, _ := ret[0].(simpleBankDB.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetUser(arg0 context.Context, arg1 string) (simpleBankDB.User, error) {
	m.ctrl.T.Helper()
